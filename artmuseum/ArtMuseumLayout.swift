...
protocol ArtMuseumLayoutDelegate {
...
class ArtMuseumLayoutAttributes: UICollectionViewLayoutAttributes {
    ...
    */
    ...
    override func copy(with zone: NSZone? = nil) -> Any {
        let copy = super.copy(with: zone) as! ArtMuseumLayoutAttributes
    ...
    override func isEqual(_ object: Any?) -> Bool {
        if let attributes = object as? ArtMuseumLayoutAttributes {
...
class ArtMuseumLayout: UICollectionViewLayout {
    
    // MARK: - Properties
    
    // Keep reference to the delegate
    var delegate: ArtMuseumLayoutDelegate!
    ...
    private var cache = [ArtMuseumLayoutAttributes]()
    ...
    override class var layoutAttributesClass: AnyClass {
        return ArtMuseumLayoutAttributes.self
    }
    ...
    override func prepare() {
        ...
        if cache.isEmpty {
            ...
            for item in 0 ..< collectionView!.numberOfItems(inSection: 0) {
                ...
                let attributes = ArtMuseumLayoutAttributes(forCellWith: indexPath as IndexPath)
